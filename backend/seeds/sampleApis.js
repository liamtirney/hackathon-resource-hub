module.exports = [
    {
        ...
        youtubeLinks: [
            {
                title: "How to get started with OpenAI API",
                link: "https://www.youtube.com/watch?v=MOe3RH8sHT8"
            }
        ],
        articleLinks: [
            {
                title: "A Guide to the  OpenAI API",
                link: "https://www.makeuseof.com/openai-api-guide-what-can-you-do/"
            }
        ]
    },
    {
        title: "Spotify API",
        image: "https://images.unsplash.com/photo-1611339555312-e607c8352fd7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8c3BvdGlmeXxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=400&q=60",
        description: "The Worlds Best Music API",
        docsLink: "https://developer.spotify.com/documentation/web-api",
        youtubeLinks: [
            {
                title: "How to use Spotify's API with Python",
                link: "https://youtu.be/WAmEZBEeNmg"
            },
            {
                title: "How to use Spotify's API with React",
                link: "https://youtu.be/fVcz-1rVQcs"
            }
        ],
        articleLinks: [
            {
